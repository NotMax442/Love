const translations = {
    en: {
        ...
        offline_setting_title: "Offline Access",
        offline_setting_label: "Use Offline Packs",
        offline_setting_desc: "Enable offline packs, downloads, and offline page caching.",
        offline_status_on: "On",
        offline_status_off: "Off",
        setting_status_on: "On",
        setting_status_off: "Off",
        ...
        account_design_title: "Design",
        account_design_desc: "Choose how the whole platform looks. This does not change your result review style.",
        account_design_current: "Current Design",
        account_design_current_desc: "Keep the design you are using now.",
        account_design_new: "New Dashboard",
        account_design_new_desc: "A cleaner study-focused layout with clearer sections.",
        ...
        about_sub: "A free study space for medical students to learn, review, and self-test.",
        about_mission_title: "Our Mission",
        about_mission_desc: "TestforUHS was built to make studying a little easier. It gives medical students a simple place to review questions, practice like a real exam, and keep track of the topics they miss—without paying for access.",
        about_funding_title: "How TestforUHS Stays Free & Funded",
        about_funding_desc: "We want this platform to stay open and free for everyone, so we cover the cost of hosting, the domain, and maintenance in a simple and transparent way:",
        about_ad_title: "1. Light Advertising (Google AdSense)",
        about_ad_loc: "Ads only appear at the bottom of the Home page and on the Session Results page.",
        about_ad_zero: "No interruptions during study: we do not place ads inside active quiz or study screens, so you can stay focused.",
        about_ad_filter: "We keep the ads filtered and limited. We block adult content, gambling, clickbait, and anything misleading.",
        about_donate_title: "2. Optional Support from the Community (KHQR Donations)",
        about_donate_desc: "If TestforUHS has been helpful for your studies, you can choose to support the platform through the Support Us button with KHQR. It is completely optional, and it does not give anyone extra benefits or special access.",
    ...
    km: {
        ...
        offline_setting_title: "ការប្រើប្រាស់អอฟ្លាញ",
        offline_setting_label: "ប្រើកញ្ចប់អอฟ្លាញ",
        offline_setting_desc: "បើកដំណើរការកញ្ចប់អอฟ្លាញ ការទាញយក និងការរក្សាទុកទំព័រអอฟ្លាញ។",
        offline_status_on: "បើក",
        offline_status_off: "បិទ",
        setting_status_on: "បើក",
        setting_status_off: "បិទ",
        ...
        account_design_title: "រចនាបថ",
        account_design_desc: "ជ្រើសរើសរបៀបបង្ហាញរបស់វេទិកាទាំងមូល។ វាមិនប៉ះពាល់ដល់របៀបបង្ហាញលទ្ធផលទេ។",
        account_design_current: "រចនាបថបច្ចុប្បន្ន",
        account_design_current_desc: "រក្សារចនាបថដែលអ្នកកំពុងប្រើ។",
        account_design_new: "ផ្ទាំងគ្រប់គ្រងថ្មី",
        account_design_new_desc: "ប្លង់សិក្សាថ្មីដែលស្អាត និងមានផ្នែកច្បាស់ជាងមុន។",
